...
const COLUMNS: Array<[keyof MappedProfessional | 'schedulerUrl', string]> = [
  ...
  ['specialties', 'specialties'], ['specialtyOther', 'specialty_other'],
  ...
  ['socialLinks', 'social_links'], ['legacyUrl', 'legacy_url'],
...
function toRow(r: any): ProfessionalRow {
  return {
    ...
    specialties: r.specialties ?? undefined, specialtyOther: r.specialty_other ?? undefined,
    ...
    legacyUrl: r.legacy_url ?? undefined,
